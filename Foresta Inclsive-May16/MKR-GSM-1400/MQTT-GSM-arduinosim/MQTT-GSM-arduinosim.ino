...
const char pin[]      = "0000";
const char apn[]      = "prepay.pelion";
const char login[]    = "arduino";
...
void connect() {
  ...
  Serial.print("\nconnecting...");
  while (!client.connect("Jane-GSMarduino", "83aa4496", "02ffd19115bcd0ed")) {
    Serial.print(".");
    delay(1000);
  }
...
void loop() {
  ...
  // publish a message roughly every 2 minutes.
