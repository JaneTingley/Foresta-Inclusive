...
// This program receives the moisture threhold and the valve time from either a processing sketch or an arduino
...
void connect() {
  ...
  while (!client.connect("Foresta-InclusiveGARDEN", "c9f6b6d3", "055ad1c0d8de9605")) {
    Serial.print(".");
    delay(1000);
  }
