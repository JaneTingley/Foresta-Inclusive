...
// This program opens and closes a ball valve through ethernet. It receives
// sensor value from Shiftr and turns on and off a ballvalve with hbridge
...
int motorPin1 = 6;
int motorPin2 = 7;
int sensorValue = 0;  // variable set up for the sensor value received by shiftr
