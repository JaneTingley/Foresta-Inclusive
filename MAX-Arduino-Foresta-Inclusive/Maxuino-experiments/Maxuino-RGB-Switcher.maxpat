...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1345.66666704416275, 295.510375499725342, 69.0, 20.0 ],
					"text" : "blue values"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1163.0, 295.510375499725342, 69.0, 20.0 ],
					"text" : "pink values"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 984.0, 297.510375499725342, 80.0, 20.0 ],
					"text" : "yellow values"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 19.2139892578125, 631.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "int", "int" ],
					"patching_rect" : [ 19.2139892578125, 658.610596060752869, 48.0, 22.0 ],
					"text" : "change"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 1084.33333283662796, 263.200003325939178, 70.0, 22.0 ],
					"text" : "split 10 500"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 1270.16666704416275, 268.0, 34.0, 22.0 ],
					"text" : "sel 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 1270.16666704416275, 238.789904832839966, 39.0, 22.0 ],
					"text" : "<= 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 936.999998986721039, 232.799998879432678, 46.0, 22.0 ],
					"text" : ">= 500"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 936.999998986721039, 263.200003325939178, 34.0, 22.0 ],
					"text" : "sel 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1270.16666704416275, 295.510375499725342, 72.0, 22.0 ],
					"text" : "0. 0.17 0.91"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1084.33333283662796, 295.510375499725342, 72.0, 22.0 ],
					"text" : "0.53 0. 0.19"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 904.0, 297.510375499725342, 69.0, 22.0 ],
					"text" : "0.84 0.44 0"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 905.499998986721039, 407.0, 87.0, 22.0 ],
					"text" : "unpack 0. 0. 0."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 905.499998986721039, 329.857859790325165, 144.5, 67.095835983753204 ],
					"saturation" : 1.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "float", "float", "float" ],
					"patching_rect" : [ 1270.16666704416275, 402.5, 87.0, 22.0 ],
					"text" : "unpack 0. 0. 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "float", "float", "float" ],
					"patching_rect" : [ 1084.33333283662796, 402.5, 87.0, 22.0 ],
					"text" : "unpack 0. 0. 0."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1270.16666704416275, 327.80487060546875, 144.5, 69.148825168609619 ],
					"saturation" : 1.0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1084.33333283662796, 327.80487060546875, 152.666667282581329, 69.148825168609619 ],
					"saturation" : 1.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 202.7139892578125, 783.410596549510956, 29.5, 22.0 ],
					"text" : "3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 154.7139892578125, 783.410596549510956, 29.5, 22.0 ],
					"text" : "11"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 124.7139892578125, 754.410596549510956, 29.5, 22.0 ],
					"text" : "10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 88.2139892578125, 726.410596549510956, 29.5, 22.0 ],
					"text" : "9"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 77.2139892578125, 872.410596549510956, 77.0, 22.0 ],
					"text" : "s to-maxuino"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 77.2139892578125, 842.410596549510956, 97.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 469.0, 208.06158447265625, 50.0, 22.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 330.5, 44.58990478515625, 478.5, 44.58990478515625 ],
					"order" : 0,
					"source" : [ "obj-179", 0 ]
				}
